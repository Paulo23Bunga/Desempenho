<?php
  ...
  if (isset($_POST['entrarProf'])) {
    ...
    $traz_dados = "SELECT nome_prof FROM tb_professor WHERE nome_prof LIKE '$email'";
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        $traz_dados1 = "SELECT * FROM tb_professor WHERE nome_prof LIKE '$email' AND senha  LIKE '$senha'";
